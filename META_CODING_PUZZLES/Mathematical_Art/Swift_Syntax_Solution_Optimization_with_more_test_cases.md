...
Explanation:
1. We defined custom types (Point and LineSegment) that automatically conform to Hashable.
2. The drawing logic now creates horizontal and vertical segments using these types.
3. Intersection and arm‑detection logic now works with the custom structs.
